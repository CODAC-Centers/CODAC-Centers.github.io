/* CODAC — table sorting/filtering, the photo lightbox, the hero video's
...
(function () {
  ...
  function setupLightbox() {
    var galleries = document.querySelectorAll(".codac-gallery, .codac-collage");
    if (!galleries.length || typeof HTMLDialogElement === "undefined") return;

    var dialog = document.createElement("dialog");
    dialog.className = "codac-lightbox";
    dialog.innerHTML =
      '<button type="button" class="codac-lightbox__close" aria-label="Close">&times;</button>' +
    ...
    dialog.querySelector(".codac-lightbox__close").addEventListener("click", function () {
      dialog.close();
    });
  ...
  function setupHeroVideos() {
    var videos = document.querySelectorAll(".codac-hero__video");
    ...
    Array.prototype.forEach.call(videos, function (video) {
      ...
      var button = document.createElement("button");
      button.type = "button";
      button.className = "codac-hero__toggle";
  ...
  function setupCopyLinks() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll(".codac-share__copy"), function (button) {
      button.hidden = false;
      button.addEventListener("click", function () {
  ...
  function init() {
    Array.prototype.forEach.call(document.querySelectorAll(".codac-tablewrap"), function (wrap) {
      var table = wrap.querySelector("table.codac-table");
      if (!table) return;
      setupSorting(table);
